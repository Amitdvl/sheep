...
- **MCP:** mcp__sheep__* (send_message, schedule_task, list_tasks, pause_task, resume_task, cancel_task, update_task, register_group)
...
```
Call mcp__sheep__list_tasks to get scheduled tasks.
```
