...
- Check bot is started: `tail -f logs/sheep.log`
...
6. Rebuild: `npm run build && launchctl kickstart -k gui/$(id -u)/com.sheep` (macOS) or `npm run build && systemctl --user restart sheep` (Linux)
